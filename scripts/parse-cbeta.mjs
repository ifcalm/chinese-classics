// CBETA TEI-P5 XML → base-data markdown(经藏批②③④⑤已收43部;批①密教11部已撤收待前端小字注样式,配置保留可随时重收)。
...
const BASE = '/Users/lishuaishuai/Projects/githubProjects/chinese-classics/base-data/buddha/jingzang'
...
const BOOKS = [
  ...
  ['T04n0200', '撰集百缘经', 'zhuan-ji-bai-yuan-jing', 'benyuan', 90, '三国吴支谦译，十卷百缘，记佛世因缘果报故事。'],
  ['T03n0152', '六度集经', 'liu-du-ji-jing', 'benyuan', 100, '三国吴康僧会译，八卷九十一章，依六度编次佛本生故事。'],
  ['T03n0154', '生经', 'sheng-jing', 'benyuan', 110, '西晋竺法护译，五卷五十五经，佛及弟子本生因缘。'],
  ['T04n0211', '法句譬喻经', 'fa-ju-pi-yu-jing', 'benyuan', 120, '西晋法炬、法立共译，四卷，法句偈颂配缘起譬喻。'],
  ['T04n0212', '出曜经', 'chu-yao-jing', 'benyuan', 130, '姚秦竺佛念译，三十卷，法句偈颂广释，缘喻宏富。'],
  ['T04n0192', '佛所行赞', 'fo-suo-xing-zan', 'benyuan', 140, '马鸣菩萨造，北凉昙无谶译，五卷二十八品，五言偈颂佛传长诗。'],
  ['T03n0157', '悲华经', 'bei-hua-jing', 'benyuan', 150, '北凉昙无谶译，十卷，说释迦牟尼秽土成佛之大悲本愿。'],
  ['T04n0202', '贤愚经', 'xian-yu-jing', 'benyuan', 160, '元魏慧觉等在高昌译，十三卷六十九品，因缘故事集。'],
  ['T04n0203', '杂宝藏经', 'za-bao-zang-jing', 'benyuan', 170, '元魏吉迦夜共昙曜译，十卷百二十一章，因缘譬喻故事集。'],
  ['T03n0190', '佛本行集经', 'fo-ben-xing-ji-jing', 'benyuan', 180, '隋闍那崛多译，六十卷六十品，集诸部佛传之大成。'],
  // 批③ 般若部译系(大般若10之后、金刚经20之前;能断金刚21)
  ['T08n0224', '道行般若经', 'dao-xing-bo-re-jing', 'bore', 11, '后汉支娄迦谶译于洛阳（179年），十卷三十品，现存最早汉译般若经。'],
  ['T08n0225', '大明度经', 'da-ming-du-jing', 'bore', 12, '三国吴支谦译，六卷三十品，道行般若之异译，文辞简约。'],
  ['T08n0222', '光赞经', 'guang-zan-jing', 'bore', 13, '西晋竺法护译（286年），十卷二十七品，大品般若之初译。'],
  ['T08n0221', '放光般若经', 'fang-guang-bo-re-jing', 'bore', 14, '西晋无罗叉共竺叔兰译（291年），二十卷九十品，两晋般若学所宗。'],
  ['T08n0232', '文殊师利所说摩诃般若波罗蜜经', 'wen-shu-bo-re-jing', 'bore', 15, '梁曼陀罗仙译，二卷，文殊般若，一行三昧出此。'],
  ['T08n0231', '胜天王般若波罗蜜经', 'sheng-tian-wang-bo-re-jing', 'bore', 16, '陈月婆首那译，七卷十六品。'],
  ['T08n0239', '佛说能断金刚般若波罗蜜多经', 'fo-shuo-neng-duan-jin-gang-jing', 'bore', 21, '唐义净译（703年），一卷，金刚经最后一译。'],
  // 批④ 经集部要典(仁王经系110之后)
  ['T15n0642', '佛说首楞严三昧经', 'fo-shuo-shou-leng-yan-san-mei-jing', 'jingji', 120, '姚秦鸠摩罗什译，二卷，说首楞严三昧健行不坏之力。'],
  ['T15n0586', '思益梵天所问经', 'si-yi-fan-tian-suo-wen-jing', 'jingji', 130, '姚秦鸠摩罗什译，四卷十八品，网明菩萨与思益梵天问答实相。'],
  ['T15n0639', '月灯三昧经', 'yue-deng-san-mei-jing', 'jingji', 140, '高齐那连提耶舍译，十卷，即三昧王经，禅门多所援引。'],
  ['T15n0643', '佛说观佛三昧海经', 'fo-shuo-guan-fo-san-mei-hai-jing', 'jingji', 150, '东晋佛陀跋陀罗译，十卷十二品，说观佛相好之法。'],
  ['T16n0666', '大方等如来藏经', 'da-fang-deng-ru-lai-zang-jing', 'jingji', 160, '东晋佛陀跋陀罗译，一卷，九喻显众生皆具如来藏。'],
  ['T16n0668', '佛说不增不减经', 'fo-shuo-bu-zeng-bu-jian-jing', 'jingji', 170, '元魏菩提流支译，一卷，说众生界不增不减，如来藏系要典。'],
  ['T16n0681', '大乘密严经', 'da-cheng-mi-yan-jing', 'jingji', 180, '唐地婆诃罗译，三卷八品，会如来藏与阿赖耶识。'],
  ['T15n0650', '诸法无行经', 'zhu-fa-wu-xing-jing', 'jingji', 190, '姚秦鸠摩罗什译，二卷，说诸法性空、贪恚痴即道。'],
  ['T14n0482', '持世经', 'chi-shi-jing', 'jingji', 200, '姚秦鸠摩罗什译，四卷，说菩萨观五阴十八性因缘之法。'],
  ['T15n0653', '佛藏经', 'fo-zang-jing', 'jingji', 210, '姚秦鸠摩罗什译，三卷十品，说诸法无相、破戒不受供之诫。'],
  ['T17n0721', '正法念处经', 'zheng-fa-nian-chu-jing', 'jingji', 220, '元魏瞿昙般若流支译，七十卷，广明六道业果，义净推为修行者要典。'],
  // 批④ 禅经组(jingji/chanjing 子目录, dir weight 230)
  ['T15n0606', '修行道地经', 'xiu-xing-dao-di-jing', 'jingji/chanjing', 10, '西晋竺法护译，七卷三十品，众护菩萨造，汉传禅观早期要籍。'],
  ['T15n0614', '坐禅三昧经', 'zuo-chan-san-mei-jing', 'jingji/chanjing', 20, '姚秦鸠摩罗什译，二卷，五门禅法，江东禅业之始。'],
  ['T15n0613', '禅秘要法经', 'chan-mi-yao-fa-jing', 'jingji/chanjing', 30, '姚秦鸠摩罗什译，三卷，说白骨观等三十观法。'],
  ['T15n0616', '禅法要解', 'chan-fa-yao-jie', 'jingji/chanjing', 40, '姚秦鸠摩罗什译，二卷，释四禅四无量四无色定之修法。'],
  ['T15n0618', '达摩多罗禅经', 'da-mo-duo-luo-chan-jing', 'jingji/chanjing', 50, '东晋佛陀跋陀罗译于庐山，二卷十七品，说安般不净诸观。'],
  // 批⑤ 查漏
  ['T02n0100', '别译杂阿含经', 'bie-yi-za-ahan-jing', 'ahan', 35, '失译（约三秦时期），十六卷三百六十四经，杂阿含之别行古译。'],
  ['T01n0024', '起世经', 'qi-shi-jing', 'ahan', 50, '隋闍那崛多等译，十卷十二品，说世界成坏、诸趣居处。'],
  ['T12n0387', '大方等无想经', 'da-fang-deng-wu-xiang-jing', 'niepan', 90, '北凉昙无谶译，六卷，即大云经，说佛性常住、大云密藏。'],
  ['T12n0390', '佛临涅槃记法住经', 'fo-lin-nie-pan-ji-fa-zhu-jing', 'niepan', 100, '唐玄奘译（652年），一卷，记正法住灭一千年之相。'],
  ['T12n0396', '佛说法灭尽经', 'fo-shuo-fa-mie-jin-jing', 'niepan', 110, '刘宋时失译，一卷，说法欲灭时诸恶乱象与月光出世。'],
  ['T13n0423', '僧伽吒经', 'seng-qie-zha-jing', 'daji/danxing', 70, '元魏月婆首那译，四卷，说僧伽吒法门闻者灭罪之力。'],
  ['T09n0273', '金刚三昧经', 'jin-gang-san-mei-jing', 'fahua', 60, '失译（北凉录），说一味实际无相观法，元晓《金刚三昧经论》所疏。'],
  ['T09n0270', '大法鼓经', 'da-fa-gu-jing', 'fahua', 70, '刘宋求那跋陀罗译，二卷，说一乘常住、如来藏义。'],
  ['T12n0323', '郁迦罗越问菩萨行经', 'yu-jia-luo-yue-wen-pu-sa-xing-jing', 'baoji/yiyi', 100, '西晋竺法护译，一卷，说在家出家菩萨戒行，大宝积经郁伽长者会之异译。'],
  ['T12n0371', '观世音菩萨授记经', 'guan-shi-yin-pu-sa-shou-ji-jing', 'baoji/yiyi', 110, '刘宋昙无竭译，一卷，记观世音、得大势二菩萨往因与授记。'],
  // 批① 密教部(按大正藏经号序;楞严经既有,weight 改 60)
  ['T18n0848', '大毗卢遮那成佛神变加持经', 'da-pi-lu-zhe-na-cheng-fo-shen-bian-jia-chi-jing', 'mijiao', 10, '唐善无畏共一行译，七卷三十六品，即《大日经》，胎藏界根本经典。'],
  ['T18n0865', '金刚顶一切如来真实摄大乘现证大教王经', 'jin-gang-ding-da-jiao-wang-jing', 'mijiao', 20, '唐不空译，三卷，即《金刚顶经》，金刚界根本经典。'],
  ['T18n0893a', '苏悉地羯罗经', 'su-xi-di-jie-luo-jing', 'mijiao', 30, '唐输波迦罗（善无畏）译，三卷，说三部悉地成就法，与大日、金刚顶并称密教三大部。'],
  ['T18n0895a', '苏婆呼童子请问经', 'su-po-hu-tong-zi-qing-wen-jing', 'mijiao', 40, '唐输波迦罗（善无畏）译，三卷，说持诵者律仪轨范，密教受持之律。'],
  ['T18n0897', '蕤呬耶经', 'rui-xi-ye-jing', 'mijiao', 50, '唐不空译，三卷，说择地造坛、供养奉请之通则。'],
  ['T19n0967', '佛顶尊胜陀罗尼经', 'fo-ding-zun-sheng-tuo-luo-ni-jing', 'mijiao', 70, '唐佛陀波利译（683年），一卷，说尊胜陀罗尼灭罪延寿之力，经幢刻此殆遍天下。'],
  ['T19n0982', '佛母大孔雀明王经', 'fo-mu-da-kong-que-ming-wang-jing', 'mijiao', 80, '唐不空译，三卷，说孔雀明王真言除灾祛毒护国之法。'],
  ['T19n1022A', '一切如来心秘密全身舍利宝箧印陀罗尼经', 'bao-qie-yin-tuo-luo-ni-jing', 'mijiao', 90, '唐不空译，一卷，说宝箧印陀罗尼，塔藏经咒之制多出于此。'],
  ['T20n1050', '佛说大乘庄严宝王经', 'fo-shuo-da-cheng-zhuang-yan-bao-wang-jing', 'mijiao', 100, '宋天息灾译，四卷，说观自在菩萨功德与六字大明陀罗尼（唵嘛呢叭咪吽）之所出。'],
  ['T20n1060', '千手千眼观世音菩萨广大圆满无碍大悲心陀罗尼经', 'da-bei-xin-tuo-luo-ni-jing', 'mijiao', 110, '唐伽梵达摩译，一卷，说千手观音大悲心陀罗尼（大悲咒）及其十大愿力。'],
  ['T20n1076', '七俱胝佛母所说准提陀罗尼经', 'zhun-ti-tuo-luo-ni-jing', 'mijiao', 120, '唐不空译，一卷，说准提陀罗尼持诵仪则。'],
]
