# -*- coding: utf-8 -*-
"""昭明文選·抓取。維基《昭明文選》60卷+序+卷19續。"""
import subprocess, json, time, os
UA='chinese-classics-bot/1.0 (ifcalm.ok@gmail.com)'
API='https://zh.wikisource.org/w/api.php'
S=os.environ.get('WX_CACHE_DIR', os.path.dirname(os.path.abspath(__file__)))
OUT=os.path.join(S,'wxcache.json')
...
titles = ['昭明文選','昭明文選/序','昭明文選/卷19續'] + ['昭明文選/卷%d'%i for i in range(1,61)]
